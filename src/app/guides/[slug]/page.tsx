  ...
  return (
    <>
      ...
      <main className="container mx-auto px-4 py-8 max-w-3xl">
        ...
        {tool && (
          <Link href={`/tools/${tool.slug}`} className="block p-5 mb-8 rounded-xl border border-purple-200 dark:border-purple-900 bg-purple-50 dark:bg-purple-950/20 hover:border-purple-500 transition">
            <div className="flex items-center gap-3">
              <span className="text-3xl">{tool.icon}</span>
              <div className="flex-1">
                <p className="text-xs uppercase tracking-wider text-purple-700 dark:text-purple-400 mb-0.5">Use the calculator</p>
          ...
          <ol className="space-y-5">
            {g.steps.map((s, i) => (
              <li key={i} className="flex gap-4">
                <span className="flex-shrink-0 w-8 h-8 rounded-full bg-purple-600 text-white flex items-center justify-center font-bold text-sm">{i + 1}</span>
                <div>
